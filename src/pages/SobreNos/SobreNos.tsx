      ...
      <Container maxWidth="lg">
        ...
        <div className="corpomvv">
          ...
          <div className='blocoColaboradores'>
            ...
            <div className="cardDosDevs">
              <div className='imgDev2'><p style={{ fontWeight: 'bold' }}>Bruna Leitão</p><p>Apaixonada por livros e por conhecer coisas novas, recentemente descobri que também amo programar. Tenho estudado para me tornar desenvolvedora, com foco em back-end. Cada dia mais entusiasmada a explorar o universo da tecnologia e programação.</p></div>
              <div className="corpoContatoDev">
